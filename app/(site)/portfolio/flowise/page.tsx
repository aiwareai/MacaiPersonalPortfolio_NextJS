          ...
          <div className="flex flex-col-reverse lg:flex-row gap-7.5 xl:gap-12.5">
              ...
              <div className="animate_top rounded-md shadow-solid-13 bg-white dark:bg-blacksection border border-stroke dark:border-strokedark p-9 mb-10">
                ...
                <ul>
                  <li className="last:mb-0 mb-3 transition-all duration-300">
                    <p>Link:</p>
                    <a href="https://piotr-macai-flowise.hf.space/chatbot/78e7f355-55fb-4cc2-aea9-72c8ffd170cd" target="_blank" rel="noopener noreferrer" className="text-white transition-all duration-300 hover:text-primary">My Huggingface space</a>
                  </li>
                  <li className="last:mb-0 mb-3 transition-all duration-300">
                  ...
                  <li className="last:mb-0 mb-3 transition-all duration-300">
                    ...
                    <p className="text-white transition-all duration-300 hover:text-primary">Flowise + OpenAI API</p>
                  </li>
                  {/* <li className="last:mb-0 mb-3 transition-all duration-300">
                    <p>Cel:</p>
            ...
            <div className="lg:w-2/3">
              <div className="animate_top rounded-md shadow-solid-13 bg-white dark:bg-blacksection border border-stroke dark:border-strokedark p-7.5 md:p-10">
                ...
                {t('mainPortfolio.macaibot.header')}
                </h2>
                <div className="mb-10 w-full overflow-hidden ">
           
                  <div className="relative aspect-[97/60] w-full sm:aspect-[97/78]">
                    <Image
                      src={"/images/portfolio/flowisebot.jpg"}
