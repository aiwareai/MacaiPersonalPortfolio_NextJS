          ...
          <div className="flex items-center gap-8 lg:gap-32.5">
            ...
            >
              <h4 className="text-black dark:text-white font-medium uppercase">
                ...
                {t('heroWebSection.aboutWeb.header1.header1')}
                </span>{" "}
                {t('heroWebSection.aboutWeb.header1.header2')}
              </h4>
              <h2 className="relative font-bold text-black dark:text-white text-3xl xl:text-hero mb-6">
             {t('heroWebSection.aboutWeb.header1.header3')}
           ...
           {t('heroWebSection.aboutWeb.header1.header4')}
                </span>
              </h2>
              <p>
              {t('heroWebSection.aboutWeb.header1.desc1')}             
               </p>
               <div>
                <a
                  href="/contact"
