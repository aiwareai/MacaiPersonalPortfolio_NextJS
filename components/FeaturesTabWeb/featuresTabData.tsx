...
const featuresTabData: FeatureTab[] = [
  {
    id: "tabOne",
    title: t('heroWebSection.WebFeaturesTab.tab1Title'),
    desc1: t('heroWebSection.WebFeaturesTab.tab1Description1'),
    desc2: t('heroWebSection.WebFeaturesTab.tab1Description1'),
    image: "/images/features/undraw_wireframing.svg",
    imageDark: "/images/features/undraw_wireframing.svg",
  },
  {
    id: "tabTwo",
    title: t('heroWebSection.WebFeaturesTab.tab2Title'),
    desc1: t('heroWebSection.WebFeaturesTab.tab2Description1'),
    desc2: t('heroWebSection.WebFeaturesTab.tab2Description2'),
    image: "/images/features/undraw_online_stats.svg",
    imageDark: "/images/features/undraw_online_stats.svg",
  },
  {
    id: "tabThree",
    title: t('heroWebSection.WebFeaturesTab.tab3Title'),
    desc1: t('heroWebSection.WebFeaturesTab.tab3Description1'),
    desc2: t('heroWebSection.WebFeaturesTab.tab3Description2'),
