...
const featuresTabData: FeatureTab[] = [
  ...
  {
    id: "tabTwo",
    title: t('heroMarketingSection.FeaturesTab.tab2Title'),
    desc1: t('heroMarketingSection.FeaturesTab.tab2Description1'),
    desc2: t('heroMarketingSection.FeaturesTab.tab2Description2'),
    image: "/images/features/undraw_status_update.svg",
    imageDark: "/images/features/undraw_status_update.svg",
  },
  {
    id: "tabThree",
    title: t('heroMarketingSection.FeaturesTab.tab3Title'),
    desc1: t('heroMarketingSection.FeaturesTab.tab3Description1'),
    desc2: t('heroMarketingSection.FeaturesTab.tab3Description2'),
    image: "/images/features/undraw_social_media.svg",
    imageDark: "/images/features/undraw_social_media.svg",
  },
];
